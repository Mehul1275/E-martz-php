...
<div class="modern-page-header fade-in" style="margin-top: -40px;">
    ...
    <div class="subtitle">Create a new mid-level product category</div>
    <div class="header-actions">
        <a href="mid-category.php" class="btn-back">
    ...
    <form action="" method="post">
        <div class="form-body">
            ...
            <div class="modern-form-group">
                ...
                <input type="text" name="mcat_name" class="modern-form-input" 
                       placeholder="Enter mid-level category name (e.g., Smartphones, T-Shirts, Kitchen)" 
                       required>
            </div>
        </div>
        
        <div class="form-actions">
            <a href="mid-category.php" class="btn-cancel">
