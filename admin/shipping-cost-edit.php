...
<div class="modern-page-header" style="margin-top: -40px;">
    ...
    <p class="subtitle">Update shipping cost information for different countries</p>
    <div style="margin-top: 1rem;">
        <a href="shipping-cost.php" class="modern-btn-secondary">
            <i class="fa fa-list"></i>
            View All Shipping Costs
        </a>
    </div>
</div>
                ...
                <form action="" method="post">
                    <div class="form-row">
                        <div class="modern-form-group">
                            ...
                            <select name="country_id" class="modern-form-select" required>
                                ...
                                foreach ($result as $row) {
                                    ?>
                                    <option value="<?php echo $row['country_id']; ?>" <?php if($row['country_id'] == $country_id) {echo 'selected';} ?>><?php echo htmlspecialchars($row['country_name']); ?></option>
                                    <?php
                                }
                                ?>
                            </select>
