...
<div class="modern-page-header fade-in" style="margin-top: -40px;">
    ...
    <div class="subtitle">Create a new top-level product category</div>
    <div class="header-actions">
        <a href="top-category.php" class="btn-back">
    ...
    <form action="" method="post">
        <div class="form-body">
            <div class="modern-form-group">
                ...
                <input type="text" name="tcat_name" class="modern-form-input" 
            ...
            <div class="modern-form-group">
                <label class="modern-form-label">
                    Show on Menu<span class="required">*</span>
                </label>
                <select name="show_on_menu" class="modern-form-select" required>
                    <option value="0">No - Hide from navigation menu</option>
                    <option value="1">Yes - Display in navigation menu</option>
                </select>
            </div>
        </div>
        
        <div class="form-actions">
            <a href="top-category.php" class="btn-cancel">
