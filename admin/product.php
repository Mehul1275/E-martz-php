				...
				<div class="box-body table-responsive">
					...
					<thead class="thead-dark">
							<tr>
								...
								<th width="160">Product Company Name</th>
								<th width="120">Product Add Date</th>
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									...
									<td><?php echo isset($row['company_name']) ? htmlspecialchars($row['company_name']) : 'N/A'; ?></td>
									<td><?php echo isset($row['created_at']) ? date('Y-m-d H:i', strtotime($row['created_at'])) : 'N/A'; ?></td>
