...
<div class="modern-page-header fade-in" style="margin-top: -40px;">
    ...
    <div class="subtitle">Create a new product color option</div>
    <div class="header-actions">
        <a href="color.php" class="btn-back">
    ...
    <form action="" method="post">
        <div class="form-body">
            <div class="modern-form-group">
                ...
                <input type="text" name="color_name" class="modern-form-input" 
                       placeholder="Enter color name (e.g., Red, Blue, Green, Black)" 
                       required>
            </div>
        </div>
        
        <div class="form-actions">
            <a href="color.php" class="btn-cancel">
                <i class="fa fa-times"></i> Cancel
            </a>
            <button type="submit" name="form1" class="btn-submit">
                <i class="fa fa-save"></i> Add Color
            </button>
        </div>
    </form>
</div>
