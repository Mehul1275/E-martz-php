	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">E-martz</span>
			</a>
					...
					<ul class="nav navbar-nav">
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img src="../assets/uploads/<?php echo htmlspecialchars(isset($_SESSION['user']['photo']) && $_SESSION['user']['photo'] ? $_SESSION['user']['photo'] : 'user-1.png', ENT_QUOTES, 'UTF-8'); ?>" class="user-image" alt="User Image">
								<span class="hidden-xs">
									<?php echo htmlspecialchars(isset($_SESSION['user']['full_name']) ? $_SESSION['user']['full_name'] : $_SESSION['user']['email'], ENT_QUOTES, 'UTF-8'); ?>
								</span>
							</a>
