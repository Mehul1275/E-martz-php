...
<div class="modern-page-header fade-in" style="margin-top: -40px;">
    ...
    <div class="subtitle">Manage product size options for your store</div>
    <div style="margin-top: 1rem;">
        <a href="size-add.php" class="btn-add-new">
...
<div class="modern-filter-bar fade-in">
    <div class="row">
        <div class="col-md-6">
            <input type="text" id="sizeSearch" class="search-box" placeholder="🔍 Search sizes by name...">
        </div>
        <div class="col-md-3">
            <div style="padding: 0.8rem 0; font-weight: 600; color: #5a5c69;">
                <i class="fa fa-info-circle"></i> Total Sizes: <span id="totalCount">0</span>
            </div>
        </div>
        <div class="col-md-3">
            <div style="padding: 0.8rem 0; text-align: right;">
                <a href="size-add.php" class="modern-btn btn-add-secondary">
            ...
            <div class="modern-table-container slide-in">
                ...
                <thead>
                    <tr>
                        ...
                        <th><i class="fa fa-tag"></i> Size Name</th>
                ...
                <tbody>
                    ...
                    foreach ($result as $row) {
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="size-info">
                                    <span class="size-name"><?php echo htmlspecialchars($row['size_name']); ?></span>
                                </div>
                            </td>
                            <td class="text-center">
                                <div class="action-buttons">
                                    <a href="size-edit.php?id=<?php echo $row['size_id']; ?>" class="modern-btn modern-btn-sm modern-btn-info" title="Edit Size">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="#" class="modern-btn modern-btn-sm modern-btn-danger" 
                                       data-href="size-delete.php?id=<?php echo $row['size_id']; ?>" 
                                       data-toggle="modal" data-target="#confirm-delete" title="Delete Size">
        ...
        <div class="modal-content modern-modal">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-warning">
                    ...
                    <strong>Warning:</strong> Deleting this size may affect products that use it.
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function filterTable() {
        ...
        for (let i = 0; i < rows.length; i++) {
            const sizeName = rows[i].getElementsByClassName('size-name')[0].textContent.toLowerCase();
