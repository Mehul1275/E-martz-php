...
<div class="modern-page-header" style="margin-top: -40px;">
    ...
    <p class="subtitle">Update frequently asked question information</p>
                ...
                <form action="" method="post">
                    ...
                    <div class="modern-form-group">
                        ...
                        <textarea name="faq_content" 
                                  ...
                                  id="editor1" 
                                  rows="8"
                                  placeholder="Enter detailed answer to the FAQ"
                                  required><?php echo htmlspecialchars($faq_content); ?></textarea>
                    </div>
