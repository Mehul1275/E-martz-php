	...
	<script>
		$(document).ready(function() {
	        ...
	        // Enable Summernote for new page fields
	        $('#editor_tnc').summernote({ height: 300 });
	        $('#editor_shipping').summernote({ height: 300 });
	        $('#editor_privacy').summernote({ height: 300 });
	        $('#editor_seller_tnc').summernote({ height: 300 });
	    });
	...
	<script>
$(function() {
  // Open user dropdown on hover
  $('.navbar-nav > .user-menu').hover(
    function() {
      $(this).addClass('open');
    },
    function() {
