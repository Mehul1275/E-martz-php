...
<div class="modern-page-header fade-in" style="margin-top: -40px;">
    ...
    <div class="subtitle">Manage intermediate product categories and their parent relationships</div>
    <div style="margin-top: 1rem;">
        <a href="mid-category-add.php" class="btn-add-new">
...
<div class="modern-filter-bar fade-in">
    <div class="row">
        <div class="col-md-6">
            <input type="text" id="categorySearch" class="search-box" placeholder="🔍 Search categories or parents...">
        </div>
        <div class="col-md-3">
        ...
        <table id="categoryTable" class="table">
            <thead>
                <tr>
                    ...
                    <th><i class="fa fa-tags"></i> Mid-Level Category</th>
                    <th><i class="fa fa-folder-open"></i> Parent Category</th>
            ...
            <tbody>
                    ...
                    $statement = $pdo->prepare("SELECT * 
                                        ...
                                        ORDER BY t2.tcat_name ASC, t1.mcat_name ASC");
                    $statement->execute();
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="category-info">
                                <span class="category-name"><?php echo htmlspecialchars($row['mcat_name']); ?></span>
                            </div>
                        </td>
                        <td>
                            <div class="parent-category">
                                <span class="parent-name"><?php echo htmlspecialchars($row['tcat_name']); ?></span>
                            </div>
                        </td>
                        <td class="text-center">
                            <span class="level-badge level-mid">Mid-Level</span>
                        </td>
                        <td class="text-center">
                            <div class="action-buttons">
                                <a href="mid-category-edit.php?id=<?php echo $row['mcat_id']; ?>" class="modern-btn modern-btn-sm modern-btn-info" title="Edit Category">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modern-modal">
            ...
            <div class="modal-body">
                <p>Are you sure you want to delete this mid-level category? This action cannot be undone.</p>
                <div class="alert alert-danger">
                    <i class="fa fa-warning"></i>
                    <strong>Critical Warning:</strong> All products and end-level categories under this mid-level category will be permanently deleted from all tables including orders, payments, sizes, colors, ratings, etc.
                </div>
                <div class="alert alert-info">
                    <i class="fa fa-info-circle"></i>
                    <strong>Impact:</strong> This will affect your entire product catalog and historical data.
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchInput.addEventListener('keyup', function() {
        ...
        for (let i = 0; i < rows.length; i++) {
            ...
            const parentName = rows[i].getElementsByClassName('parent-name')[0].textContent.toLowerCase();
