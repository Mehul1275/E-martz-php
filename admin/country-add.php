...
<div class="modern-page-header fade-in" style="margin-top: -40px;">
    ...
    <div class="subtitle">Create a new shipping country option</div>
    <div class="header-actions">
        <a href="country.php" class="btn-back">
    ...
    <form action="" method="post">
        <div class="form-body">
            <div class="modern-form-group">
                ...
                <input type="text" name="country_name" class="modern-form-input" 
                       placeholder="Enter country name (e.g., United States, India, Canada)" 
                       required>
            </div>
        </div>
        
        <div class="form-actions">
            <a href="country.php" class="btn-cancel">
                <i class="fa fa-times"></i> Cancel
            </a>
            <button type="submit" name="form1" class="btn-submit">
                <i class="fa fa-save"></i> Add Country
            </button>
        </div>
    </form>
</div>
